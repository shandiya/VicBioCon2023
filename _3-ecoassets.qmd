...
##  {#choropleth-static data-menu-title="Choropleth (static)"}
...
And this is important because it could have implications for users in deciding 
what sorts of records to include in analyses.

These datasets are, again, all available on the website.
:::
